<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="_Default" EnableViewState="false" ViewStateMode="Disabled" %>
...
<body>
    <form id="form1" runat="server">
        <table>
            <tr style="width: 100%">
                <td style="width: 100%">
                    <dx:ASPxCheckBox ID="cbEndless" runat="server" Theme="Moderno" AutoPostBack="true"
